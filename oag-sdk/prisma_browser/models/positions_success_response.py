...
class PositionsSuccessResponse(BaseModel):
    """
    Successful position update response
    """ # noqa: E501
    message: StrictStr = Field(description="Human-readable success message")
    items_updated: StrictInt = Field(description="Number of items repositioned", alias="itemsUpdated")
    __properties: ClassVar[List[str]] = ["message", "itemsUpdated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PositionsSuccessResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PositionsSuccessResponse from a dict"""
        if obj is None:
            return None
