...
class MacOSVersionAttribute(BaseModel):
    """
    MacOSVersionAttribute
    """ # noqa: E501
    any: Optional[StrictBool] = False
    versions: Optional[List[MacOSVersion]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MacOSVersionAttribute from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MacOSVersionAttribute from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "versions": [MacOSVersion.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
