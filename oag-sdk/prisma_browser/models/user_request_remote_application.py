...
class UserRequestRemoteApplication(BaseModel):
    """
    UserRequestRemoteApplication
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Remote connection")
    ...
    __properties: ClassVar[List[str]] = ["name", "address", "port", "protocol"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserRequestRemoteApplication from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserRequestRemoteApplication from a dict"""
        if obj is None:
            return None
