...
class DeviceGroupRequest(BaseModel):
    ...
    DeviceGroupRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="Device group name")
    platform: DeviceGroupPlatform
    attributes: Optional[AttributeObject] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "platform", "attributes"]
