...
class AttributeObjectMobileDeviceManufacturers(BaseModel):
    """
    Check if the mobile device is from specific manufacturers (e.g., Apple, Samsung)
    """ # noqa: E501
    enabled: StrictBool
    vendors: Optional[List[MobileManufacturer]] = Field(default=None, description="List of mobile device manufacturers to check for")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["enabled", "vendors"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttributeObjectMobileDeviceManufacturers from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttributeObjectMobileDeviceManufacturers from a dict"""
        if obj is None:
            return None
