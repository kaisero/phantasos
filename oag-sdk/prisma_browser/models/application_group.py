...
class ApplicationGroup(BaseModel):
    ...
    applications: Optional[List[ApplicationGroupApplicationsInner]] = Field(default=None, description="IDs of the group members")
    metadata: Metadata
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "description", "applications", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "applications": [ApplicationGroupApplicationsInner.from_dict(_item) for _item in obj["applications"]] if obj.get("applications") is not None else None,
