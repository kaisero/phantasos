...
class CreateOrReplaceAppGroupInput(BaseModel):
    """
    CreateOrReplaceAppGroupInput
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the application group")
    description: Optional[StrictStr] = Field(default=None, description="Description of the application group")
    applications: Optional[Annotated[List[Annotated[str, Field(strict=True)]], Field(min_length=0, max_length=2000)]] = Field(default=None, description="List of member application IDs")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateOrReplaceAppGroupInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateOrReplaceAppGroupInput from a dict"""
        if obj is None:
            return None
