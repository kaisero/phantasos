...
class RevokeRequestAction(BaseModel):
    """
    RevokeRequestAction
    """ # noqa: E501
    revoker_comment: Optional[StrictStr] = Field(default=None, description="Admin revoke comment", alias="revokerComment")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["revokerComment"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RevokeRequestAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RevokeRequestAction from a dict"""
        if obj is None:
            return None
