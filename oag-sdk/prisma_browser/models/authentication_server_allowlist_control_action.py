...
class AuthenticationServerAllowlistControlAction(str, Enum):
    """
    Whether to set an authentication server allowlist or unset it.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AuthenticationServerAllowlistControlAction from a JSON string"""
