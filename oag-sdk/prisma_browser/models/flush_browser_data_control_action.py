...
class FlushBrowserDataControlAction(str, Enum):
    """
    Whether Flush Browser Data is enabled.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FlushBrowserDataControlAction from a JSON string"""
