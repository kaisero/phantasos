...
class UpdateSignInPositionsRequest(BaseModel):
    """
    UpdateSignInPositionsRequest
    """ # noqa: E501
    positions: Annotated[List[PositionItem], Field(min_length=1)] = Field(description="Ordered list of all rules and sections. Array index determines position. ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateSignInPositionsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateSignInPositionsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "positions": [PositionItem.from_dict(_item) for _item in obj["positions"]] if obj.get("positions") is not None else None
        })
        return _obj
