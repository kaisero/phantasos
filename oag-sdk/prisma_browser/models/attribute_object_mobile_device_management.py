...
class AttributeObjectMobileDeviceManagement(BaseModel):
    """
    Check if the mobile device is managed by specific mobile device management systems
    """ # noqa: E501
    enabled: StrictBool
    systems: Optional[List[MobileDeviceManagementSystem]] = Field(default=None, description="Mobile device management system configurations")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["enabled", "systems"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttributeObjectMobileDeviceManagement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttributeObjectMobileDeviceManagement from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "systems": [MobileDeviceManagementSystem.from_dict(_item) for _item in obj["systems"]] if obj.get("systems") is not None else None
        })
