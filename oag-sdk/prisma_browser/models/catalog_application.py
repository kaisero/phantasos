...
class CatalogApplication(BaseModel):
    ...
    type: CatalogApplicationAllOfType
    category: Optional[StrictStr] = None
    metadata: Metadata
    urls: List[StrictStr] = Field(description="URL patterns for the application")
    catalog_name: Optional[StrictStr] = Field(default=None, description="The name in the application catalog")
    catalog_attributes: Optional[CatalogAttributes] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "description", "type", "category", "metadata", "urls", "catalog_name", "catalog_attributes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of catalog_attributes
        if self.catalog_attributes:
            _dict['catalog_attributes'] = self.catalog_attributes.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "catalog_attributes": CatalogAttributes.from_dict(obj["catalog_attributes"]) if obj.get("catalog_attributes") is not None else None
        })
