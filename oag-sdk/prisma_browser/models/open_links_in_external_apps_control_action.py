...
class OpenLinksInExternalAppsControlAction(str, Enum):
    """
    Open Links in External Apps action.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of OpenLinksInExternalAppsControlAction from a JSON string"""
