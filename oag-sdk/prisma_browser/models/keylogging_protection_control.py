...
class KeyloggingProtectionControl(BaseModel):
    """
    Prevent keyloggers from capturing user input while using the browser (Windows only).
    """ # noqa: E501
    action: KeyloggingProtectionControlAction
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KeyloggingProtectionControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KeyloggingProtectionControl from a dict"""
        if obj is None:
            return None
