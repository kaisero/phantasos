...
class PolicyPositioning(BaseModel):
    """
    Optional placement directive for the entity. On create, when omitted, the entity is placed at the top of the stack. On update, when omitted, the entity's current position is preserved.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PolicyPositioning from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PolicyPositioning from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "target": PolicyPositioningTarget.from_dict(obj["target"]) if obj.get("target") is not None else None
        })
        return _obj
