...
class LaunchingExternalApplicationsControl(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "exceptions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LaunchingExternalApplicationsControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LaunchingExternalApplicationsControl from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "exceptions": [ExternalApplicationLaunchException.from_dict(_item) for _item in obj["exceptions"]] if obj.get("exceptions") is not None else None
        })
        return _obj
