...
class MobileOsVersion(BaseModel):
    """
    MobileOsVersion
    """ # noqa: E501
    any: StrictBool
    ...
    __properties: ClassVar[List[str]] = ["any", "os"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MobileOsVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MobileOsVersion from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "any": obj.get("any"),
            "os": [MobileOs.from_dict(_item) for _item in obj["os"]] if obj.get("os") is not None else None
        })
