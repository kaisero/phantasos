...
class AttributeObjectOsVersion(BaseModel):
    """
    Check if the device is running a specific operating system version
    """ # noqa: E501
    negate: Optional[StrictBool] = False
    enabled: StrictBool
    windows: Optional[WindowsVersionAttribute] = None
    mac_os: Optional[MacOSVersionAttribute] = Field(default=None, alias="macOS")
    linux: Optional[LinuxVersionAttribute] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["negate", "enabled", "windows", "macOS", "linux"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttributeObjectOsVersion from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of mac_os
        if self.mac_os:
            _dict['macOS'] = self.mac_os.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttributeObjectOsVersion from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "windows": WindowsVersionAttribute.from_dict(obj["windows"]) if obj.get("windows") is not None else None,
            "macOS": MacOSVersionAttribute.from_dict(obj["macOS"]) if obj.get("macOS") is not None else None,
            "linux": LinuxVersionAttribute.from_dict(obj["linux"]) if obj.get("linux") is not None else None
        })
