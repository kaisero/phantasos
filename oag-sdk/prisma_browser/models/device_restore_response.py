...
class DeviceRestoreResponse(BaseModel):
    """
    DeviceRestoreResponse
    """ # noqa: E501
    restored_device_ids: Optional[List[StrictStr]] = Field(default=None, description="List of device IDs that were restored", alias="restoredDeviceIds")
    message: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["restoredDeviceIds", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceRestoreResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceRestoreResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "restoredDeviceIds": obj.get("restoredDeviceIds"),
