...
class User(BaseModel):
    ...
    profile_picture_url: StrictStr = Field(description="Profile Picture URL", alias="profilePictureURL")
    deleted_time: datetime = Field(description="Deleted Time", alias="deletedTime")
    status: UserStatus
    provider: UserProvider
    device_ids: Optional[List[StrictStr]] = Field(default=None, description="Device IDs", alias="deviceIds")
    user_groups: Optional[List[UserGroup]] = Field(default=None, description="User Groups", alias="userGroups")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "externalId", "email", "lastSeen", "firstSeen", "name", "profilePictureURL", "deletedTime", "status", "provider", "deviceIds", "userGroups"]
