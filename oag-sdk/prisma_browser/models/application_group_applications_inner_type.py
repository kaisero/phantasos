...
class ApplicationGroupApplicationsInnerType(str, Enum):
    """
    ...
    CUSTOM = 'custom'
    PRIVATE = 'private'
    NON_MINUS_WEB = 'non-web'
    USER_MINUS_NON_MINUS_WEB = 'user-non-web'
    PRA = 'pra'
    DESKTOP = 'desktop'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApplicationGroupApplicationsInnerType from a JSON string"""
