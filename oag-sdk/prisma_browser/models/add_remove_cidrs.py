...
class AddRemoveCidrs(BaseModel):
    """
    Add or remove CIDRs from a private application.
    """ # noqa: E501
    add: Optional[Annotated[List[StrictStr], Field(max_length=100)]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddRemoveCidrs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddRemoveCidrs from a dict"""
        if obj is None:
            return None
