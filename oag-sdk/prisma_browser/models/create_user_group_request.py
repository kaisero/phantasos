...
class CreateUserGroupRequest(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the user group")
    user_ids: List[StrictStr] = Field(description="List of user IDs", alias="userIds")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "userIds"]
