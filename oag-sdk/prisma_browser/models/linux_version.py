...
class LinuxVersion(BaseModel):
    """
    LinuxVersion
    """ # noqa: E501
    enabled: StrictBool
    distro: Optional[LinuxDistro] = None
    min_version: Optional[StrictStr] = Field(default=None, description="Minimum Linux version (e.g., \"20.04\" for Ubuntu, \"33\" for Fedora)", alias="minVersion")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["enabled", "distro", "minVersion"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LinuxVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LinuxVersion from a dict"""
        if obj is None:
            return None
