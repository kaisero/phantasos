...
class ListApplicationsSortParameter(str, Enum):
    """
    ...
    allowed enum values
    """
    APPLICATION_DOT_ID = 'application.id'
    APPLICATION_DOT_NAME = 'application.name'
    APPLICATION_DOT_CREATE_TIME = 'application.create_time'
    APPLICATION_DOT_UPDATE_TIME = 'application.update_time'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ListApplicationsSortParameter from a JSON string"""
