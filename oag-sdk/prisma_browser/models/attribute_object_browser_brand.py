...
class AttributeObjectBrowserBrand(BaseModel):
    """
    Check if the device has specific browser brands and versions installed
    """ # noqa: E501
    negate: Optional[StrictBool] = False
    enabled: StrictBool
    brands: Optional[List[BrowserBrandDetails]] = Field(default=None, description="Browser brand and version requirements")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["negate", "enabled", "brands"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttributeObjectBrowserBrand from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttributeObjectBrowserBrand from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "brands": [BrowserBrandDetails.from_dict(_item) for _item in obj["brands"]] if obj.get("brands") is not None else None
        })
