...
class AttributeObjectFirewall(BaseModel):
    """
    ...
    any_vendor: Optional[StrictBool] = Field(default=None, description="Whether to accept any firewall vendor", alias="anyVendor")
    specific_vendors: Optional[List[FirewallVendorName]] = Field(default=None, description="Selected firewall vendors to check for", alias="specificVendors")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttributeObjectFirewall from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttributeObjectFirewall from a dict"""
        if obj is None:
            return None
