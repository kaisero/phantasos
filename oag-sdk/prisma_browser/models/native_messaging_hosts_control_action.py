...
class NativeMessagingHostsControlAction(str, Enum):
    """
    Native Messaging Hosts action.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of NativeMessagingHostsControlAction from a JSON string"""
