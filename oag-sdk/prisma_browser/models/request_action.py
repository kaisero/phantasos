...
class RequestAction(BaseModel):
    ...
    admin_comment: Optional[StrictStr] = Field(default=None, description="Admin comment on the action", alias="adminComment")
    admin_bypass_timeframe: Optional[RequestActionAdminBypassTimeframe] = Field(default=None, alias="adminBypassTimeframe")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["action", "adminComment", "adminBypassTimeframe"]
