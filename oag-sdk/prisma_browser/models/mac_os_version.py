...
class MacOSVersion(BaseModel):
    ...
    enabled: StrictBool
    major: StrictStr
    min_minor_version: Optional[StrictStr] = Field(default=None, alias="minMinorVersion")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["enabled", "major", "minMinorVersion"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MacOSVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MacOSVersion from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "major": obj.get("major"),
            "minMinorVersion": obj.get("minMinorVersion")
        })
