...
class KerberosDelegationAllowlistControl(BaseModel):
    """
    List the hosts that may forward a user's Kerberos ticket to downstream services.
    """ # noqa: E501
    action: KerberosDelegationAllowlistControlAction
    included_domains: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=2048)]], Field(max_length=1000)]] = Field(default=None, description="Include specific domains.", alias="includedDomains")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KerberosDelegationAllowlistControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KerberosDelegationAllowlistControl from a dict"""
        if obj is None:
            return None
