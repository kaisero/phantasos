...
class PatchSecurityRuleByIDRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "mode", "scope", "controls"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchSecurityRuleByIDRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchSecurityRuleByIDRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "controls": SecurityControls.from_dict(obj["controls"]) if obj.get("controls") is not None else None
        })
