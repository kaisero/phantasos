...
class JavaScriptV8JitAndWebAssemblyControl(BaseModel):
    """
    Block JavaScript v8 JIT to reduce exploitation risks and to activate vulnerability mitigation techniques. Block WebAssembly (WASM) to reduce exploitation risks.
    """ # noqa: E501
    action: JavaScriptV8JitAndWebAssemblyControlAction
    excluded_domains: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=2048)]], Field(max_length=1000)]] = Field(default=None, description="Domains excluded from the restriction.", alias="excludedDomains")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JavaScriptV8JitAndWebAssemblyControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JavaScriptV8JitAndWebAssemblyControl from a dict"""
        if obj is None:
            return None
