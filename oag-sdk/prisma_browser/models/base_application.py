...
class BaseApplication(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "type", "category", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BaseApplication from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BaseApplication from a dict"""
        if obj is None:
            return None
