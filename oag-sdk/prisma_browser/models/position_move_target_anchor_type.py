...
class PositionMoveTargetAnchorType(str, Enum):
    """
    Whether the anchor is a rule or a section. Section anchors are only valid at top level.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PositionMoveTargetAnchorType from a JSON string"""
