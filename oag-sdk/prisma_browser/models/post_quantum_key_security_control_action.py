...
class PostQuantumKeySecurityControlAction(str, Enum):
    """
    Post Quantum Key Security action.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PostQuantumKeySecurityControlAction from a JSON string"""
