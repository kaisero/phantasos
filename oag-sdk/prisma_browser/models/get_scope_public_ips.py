...
class GetScopePublicIps(BaseModel):
    """
    The public IP addresses the rule applies to.
    """ # noqa: E501
    is_any: StrictBool = Field(description="Flag indicating if any public IP addresses are included in the scope.", alias="isAny")
    public_ips: Optional[List[StrictStr]] = Field(description="Public IP addresses affected by the rule.", alias="publicIps")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetScopePublicIps from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetScopePublicIps from a dict"""
        if obj is None:
            return None
