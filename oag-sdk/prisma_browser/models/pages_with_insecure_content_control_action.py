...
class PagesWithInsecureContentControlAction(str, Enum):
    """
    Whether to allow or block Pages with Insecure Content.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PagesWithInsecureContentControlAction from a JSON string"""
