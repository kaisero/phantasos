...
class BlockExtensionsByPermissionsControlBlockedPermissionsInner(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BlockExtensionsByPermissionsControlBlockedPermissionsInner from a JSON string"""
