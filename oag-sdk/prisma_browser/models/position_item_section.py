...
class PositionItemSection(BaseModel):
    """
    A section in the desired position order
    """ # noqa: E501
    type: PositionItemSectionType
    id: Annotated[str, Field(min_length=29, strict=True, max_length=29)] = Field(description="The section ID")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PositionItemSection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PositionItemSection from a dict"""
        if obj is None:
            return None
