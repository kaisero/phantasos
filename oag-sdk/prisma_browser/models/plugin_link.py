...
class PluginLink(BaseModel):
    ...
    PluginLink
    """ # noqa: E501
    url_pattern: Optional[StrictStr] = Field(default=None, alias="urlPattern")
    reset_password_url: Optional[StrictStr] = Field(default=None, alias="resetPasswordUrl")
    login_page_url: Optional[StrictStr] = Field(default=None, alias="loginPageUrl")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["urlPattern", "resetPasswordUrl", "loginPageUrl"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PluginLink from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PluginLink from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "loginPageUrl": obj.get("loginPageUrl")
        })
