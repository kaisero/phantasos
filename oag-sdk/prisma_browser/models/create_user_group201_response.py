...
class CreateUserGroup201Response(BaseModel):
    """
    CreateUserGroup201Response
    """ # noqa: E501
    user_group_id: Optional[StrictStr] = Field(default=None, description="The ID of the newly created user group", alias="userGroupId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["userGroupId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateUserGroup201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateUserGroup201Response from a dict"""
        if obj is None:
            return None
