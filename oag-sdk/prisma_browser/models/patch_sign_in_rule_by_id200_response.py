...
class PatchSignInRuleByID200Response(BaseModel):
    """
    PatchSignInRuleByID200Response
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the rule to update.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchSignInRuleByID200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchSignInRuleByID200Response from a dict"""
        if obj is None:
            return None
