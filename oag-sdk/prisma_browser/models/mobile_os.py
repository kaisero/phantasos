...
class MobileOs(BaseModel):
    """
    MobileOs
    """ # noqa: E501
    enabled: StrictBool
    version: StrictStr
    min_security_patch: Optional[StrictStr] = Field(default=None, alias="minSecurityPatch")
    latest: Optional[StrictBool] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["enabled", "version", "minSecurityPatch", "latest"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MobileOs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MobileOs from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "minSecurityPatch": obj.get("minSecurityPatch"),
