...
class SectionPatchRequest(BaseModel):
    ...
    SectionPatchRequest
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = Field(default=None, description="The updated section name. Leading and trailing whitespace is trimmed before the value is stored. Names that are empty or consist entirely of whitespace are rejected with a 400 error. ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SectionPatchRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SectionPatchRequest from a dict"""
        if obj is None:
            return None
