...
class ListApplicationGroupsSortParameter(str, Enum):
    """
    ...
    allowed enum values
    """
    APPLICATION_GROUP_DOT_ID = 'application_group.id'
    APPLICATION_GROUP_DOT_NAME = 'application_group.name'
    APPLICATION_GROUP_DOT_CREATE_TIME = 'application_group.create_time'
    APPLICATION_GROUP_DOT_UPDATE_TIME = 'application_group.update_time'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ListApplicationGroupsSortParameter from a JSON string"""
