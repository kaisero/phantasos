...
class DeviceForceReauthResponse(BaseModel):
    """
    DeviceForceReauthResponse
    """ # noqa: E501
    forced_reauth_device_ids: Optional[List[StrictStr]] = Field(default=None, description="List of device IDs that were force re-authenticated", alias="forcedReauthDeviceIds")
    message: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["forcedReauthDeviceIds", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceForceReauthResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceForceReauthResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "forcedReauthDeviceIds": obj.get("forcedReauthDeviceIds"),
