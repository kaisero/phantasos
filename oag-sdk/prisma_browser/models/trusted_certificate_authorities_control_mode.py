...
class TrustedCertificateAuthoritiesControlMode(str, Enum):
    """
    Which certificate store the browser uses to validate TLS/SSL certificates.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TrustedCertificateAuthoritiesControlMode from a JSON string"""
