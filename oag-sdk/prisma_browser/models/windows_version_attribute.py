...
class WindowsVersionAttribute(BaseModel):
    """
    WindowsVersionAttribute
    """ # noqa: E501
    any: Optional[StrictBool] = False
    versions: Optional[List[WindowsVersion]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WindowsVersionAttribute from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WindowsVersionAttribute from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "versions": [WindowsVersion.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
