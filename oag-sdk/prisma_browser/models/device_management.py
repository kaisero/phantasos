...
class DeviceManagement(BaseModel):
    ...
    systems: List[DeviceManagementSystem] = Field(description="Device Management")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["status", "systems"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceManagement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceManagement from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "systems": [DeviceManagementSystem.from_dict(_item) for _item in obj["systems"]] if obj.get("systems") is not None else None
        })
