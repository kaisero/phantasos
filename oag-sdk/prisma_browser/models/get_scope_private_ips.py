...
class GetScopePrivateIps(BaseModel):
    """
    The private IP addresses the rule applies to.
    """ # noqa: E501
    is_any: StrictBool = Field(description="Flag indicating if any private IP addresses are included in the scope.", alias="isAny")
    private_ips: Optional[List[StrictStr]] = Field(description="Private IP addresses affected by the rule.", alias="privateIps")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetScopePrivateIps from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetScopePrivateIps from a dict"""
        if obj is None:
            return None
