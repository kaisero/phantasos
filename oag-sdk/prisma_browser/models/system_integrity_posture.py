...
class SystemIntegrityPosture(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["status", "services"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SystemIntegrityPosture from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SystemIntegrityPosture from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "services": SystemIntegrityPostureServices.from_dict(obj["services"]) if obj.get("services") is not None else None
        })
