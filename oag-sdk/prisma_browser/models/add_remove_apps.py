...
class AddRemoveApps(BaseModel):
    """
    AddRemoveApps
    """ # noqa: E501
    add: Optional[Annotated[List[Annotated[str, Field(strict=True)]], Field(max_length=2000)]] = None
    remove: Optional[Annotated[List[Annotated[str, Field(strict=True)]], Field(max_length=2000)]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddRemoveApps from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddRemoveApps from a dict"""
        if obj is None:
            return None
