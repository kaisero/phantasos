...
class BrowserBrandDetails(BaseModel):
    """
    BrowserBrandDetails
    """ # noqa: E501
    brand: BrowserBrand
    ...
    __properties: ClassVar[List[str]] = ["brand", "minVersion"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserBrandDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserBrandDetails from a dict"""
        if obj is None:
            return None
