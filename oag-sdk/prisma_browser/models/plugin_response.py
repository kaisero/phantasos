...
class PluginResponse(BaseModel):
    ...
    create_time: datetime = Field(description="Creation time of the plugin", alias="createTime")
    update_time: datetime = Field(description="Last update time of the plugin", alias="updateTime")
    plugin: Plugin
    application_id: StrictStr = Field(description="Application ID of the application the plugin is associated to", alias="applicationId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "createTime", "updateTime", "plugin", "applicationId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plugin": Plugin.from_dict(obj["plugin"]) if obj.get("plugin") is not None else None,
