...
class PositionMove(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["subject", "target"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PositionMove from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PositionMove from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "subject": PositionMoveSubject.from_dict(obj["subject"]) if obj.get("subject") is not None else None,
            "target": PositionMoveTarget.from_dict(obj["target"]) if obj.get("target") is not None else None
        })
        return _obj
