...
class CreateDeviceGroup201Response(BaseModel):
    """
    CreateDeviceGroup201Response
    """ # noqa: E501
    device_group_id: Optional[StrictStr] = Field(default=None, description="The ID of the newly created device group", alias="deviceGroupId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["deviceGroupId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateDeviceGroup201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateDeviceGroup201Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "deviceGroupId": obj.get("deviceGroupId")
        })
