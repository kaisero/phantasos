...
class ListDeviceGroupsSortParameter(str, Enum):
    """
    ...
    allowed enum values
    """
    DEVICE_GROUP_DOT_NAME = 'deviceGroup.name'
    DEVICE_GROUP_DOT_PLATFORM = 'deviceGroup.platform'
    DEVICE_GROUP_DOT_CREATED_AT = 'deviceGroup.created_at'
    DEVICE_GROUP_DOT_UPDATED_AT = 'deviceGroup.updated_at'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ListDeviceGroupsSortParameter from a JSON string"""
