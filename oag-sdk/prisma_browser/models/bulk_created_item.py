...
class BulkCreatedItem(BaseModel):
    ...
    BulkCreatedItem
    """ # noqa: E501
    id: StrictStr = Field(description="The ID of the newly created resource")
    name: StrictStr = Field(description="The name of the newly created resource")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BulkCreatedItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BulkCreatedItem from a dict"""
        if obj is None:
            return None
