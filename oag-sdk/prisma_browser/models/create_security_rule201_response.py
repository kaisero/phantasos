...
class CreateSecurityRule201Response(BaseModel):
    """
    CreateSecurityRule201Response
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the created rule (PULID, 29 chars).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSecurityRule201Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSecurityRule201Response from a dict"""
        if obj is None:
            return None
