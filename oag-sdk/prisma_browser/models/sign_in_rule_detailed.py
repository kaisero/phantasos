...
class SignInRuleDetailed(BaseModel):
    """
    ...
    description: StrictStr = Field(description="Detailed explanation of the rule's purpose")
    mode: RuleMode
    scope: GetScope
    action: SignInRuleDetailedAction
    metadata: AccessAndDataRuleDetailedMetadata
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "priority", "section", "description", "mode", "scope", "action", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SignInRuleDetailed from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SignInRuleDetailed from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "action": SignInRuleDetailedAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
