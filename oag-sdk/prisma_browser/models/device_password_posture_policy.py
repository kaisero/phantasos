...
class DevicePasswordPosturePolicy(BaseModel):
    """
    DevicePasswordPosturePolicy
    """ # noqa: E501
    complexity_req: StrictBool = Field(alias="complexityReq")
    max_password_age: StrictInt = Field(alias="maxPasswordAge")
    min_password_length: StrictInt = Field(alias="minPasswordLength")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["complexityReq", "maxPasswordAge", "minPasswordLength"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DevicePasswordPosturePolicy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DevicePasswordPosturePolicy from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "complexityReq": obj.get("complexityReq"),
            "maxPasswordAge": obj.get("maxPasswordAge"),
