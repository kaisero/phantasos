...
class MetadataConfigurationVersion(BaseModel):
    """
    Configuration version information
    """ # noqa: E501
    id: Annotated[str, Field(min_length=29, strict=True, max_length=29)] = Field(description="Configuration version identifier")
    status: MetadataConfigurationVersionStatus
    number: StrictInt = Field(description="Configuration version number")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "status", "number"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MetadataConfigurationVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MetadataConfigurationVersion from a dict"""
        if obj is None:
            return None
