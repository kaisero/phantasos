...
class KeyloggingProtectionControlAction(str, Enum):
    """
    Whether Keylogging Protection is enabled.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of KeyloggingProtectionControlAction from a JSON string"""
