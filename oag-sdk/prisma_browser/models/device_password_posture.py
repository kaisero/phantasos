...
class DevicePasswordPosture(BaseModel):
    """
    DevicePasswordPosture
    """ # noqa: E501
    enabled: StrictBool
    password_policy: Optional[DevicePasswordPosturePolicy] = Field(default=None, alias="passwordPolicy")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["enabled", "passwordPolicy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DevicePasswordPosture from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DevicePasswordPosture from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "passwordPolicy": DevicePasswordPosturePolicy.from_dict(obj["passwordPolicy"]) if obj.get("passwordPolicy") is not None else None
        })
