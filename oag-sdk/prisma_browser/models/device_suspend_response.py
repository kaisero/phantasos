...
class DeviceSuspendResponse(BaseModel):
    """
    DeviceSuspendResponse
    """ # noqa: E501
    suspended_device_ids: Optional[List[StrictStr]] = Field(default=None, description="List of device IDs that were suspended", alias="suspendedDeviceIds")
    message: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["suspendedDeviceIds", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceSuspendResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceSuspendResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "suspendedDeviceIds": obj.get("suspendedDeviceIds"),
