...
class DeviceDeleteResponse(BaseModel):
    ...
    """ # noqa: E501
    deleted_device_ids: Optional[List[StrictStr]] = Field(default=None, description="List of device IDs that were deleted", alias="deletedDeviceIds")
    message: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["deletedDeviceIds", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deletedDeviceIds": obj.get("deletedDeviceIds"),
