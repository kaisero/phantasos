...
class ListApplicationGroups200Response(BaseModel):
    """
    ListApplicationGroups200Response
    """ # noqa: E501
    data: Optional[List[ApplicationGroup]] = None
    metadata: Optional[ResponseMetadata] = None
    page_info: Optional[PageInfo] = Field(default=None, alias="pageInfo")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["data", "metadata", "pageInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListApplicationGroups200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListApplicationGroups200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [ApplicationGroup.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
