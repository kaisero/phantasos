...
class CertificateDN(BaseModel):
    """
    CertificateDN
    """ # noqa: E501
    cn: Optional[StrictStr] = Field(default=None, alias="CN")
    o: Optional[StrictStr] = Field(default=None, alias="O")
    ou: Optional[StrictStr] = Field(default=None, alias="OU")
    l: Optional[StrictStr] = Field(default=None, alias="L")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["CN", "O", "OU", "L"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CertificateDN from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CertificateDN from a dict"""
        if obj is None:
            return None
