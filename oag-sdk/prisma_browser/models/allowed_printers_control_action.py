...
class AllowedPrintersControlAction(str, Enum):
    """
    Whether any printer is allowed or only specific printers from a list.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AllowedPrintersControlAction from a JSON string"""
