...
class ListDeviceGroups200Response(BaseModel):
    """
    ListDeviceGroups200Response
    """ # noqa: E501
    page_info: Optional[PageInfo] = Field(default=None, alias="pageInfo")
    data: Optional[List[DeviceGroup]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["pageInfo", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListDeviceGroups200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListDeviceGroups200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": [DeviceGroup.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
