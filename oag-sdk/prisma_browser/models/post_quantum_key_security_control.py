...
class PostQuantumKeySecurityControl(BaseModel):
    """
    Control whether to offer a post-quantum key agreement algorithm in TLS.
    """ # noqa: E501
    action: PostQuantumKeySecurityControlAction
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostQuantumKeySecurityControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostQuantumKeySecurityControl from a dict"""
        if obj is None:
            return None
