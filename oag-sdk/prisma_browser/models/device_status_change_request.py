...
class DeviceStatusChangeRequest(BaseModel):
    ...
    """ # noqa: E501
    device_ids: Annotated[List[StrictStr], Field(min_length=1)] = Field(description="List of device IDs", alias="deviceIds")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["deviceIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceStatusChangeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceStatusChangeRequest from a dict"""
        if obj is None:
            return None
