...
class ListUsersSortParameter(str, Enum):
    """
    ...
    USER_DOT_FIRST_SEEN = 'user.first_seen'
    USER_DOT_LAST_SEEN = 'user.last_seen'
    USER_DOT_STATUS = 'user.status'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ListUsersSortParameter from a JSON string"""
