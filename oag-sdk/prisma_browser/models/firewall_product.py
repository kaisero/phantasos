...
class FirewallProduct(BaseModel):
    """
    Firewall product information
    """ # noqa: E501
    vendor_name: FirewallVendorName = Field(alias="vendorName")
    product_name: StrictStr = Field(description="Product name of the firewall", alias="productName")
    enabled: StrictBool = Field(description="Whether the firewall is enabled")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["vendorName", "productName", "enabled"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FirewallProduct from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FirewallProduct from a dict"""
        if obj is None:
            return None
