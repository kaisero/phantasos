...
class AuthenticationServerAllowlistControl(BaseModel):
    """
    List the servers allowed to use Integrated Authentication.
    """ # noqa: E501
    action: AuthenticationServerAllowlistControlAction
    included_domains: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=2048)]], Field(max_length=1000)]] = Field(default=None, description="Servers allowed to use Integrated Authentication.", alias="includedDomains")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthenticationServerAllowlistControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthenticationServerAllowlistControl from a dict"""
        if obj is None:
            return None
