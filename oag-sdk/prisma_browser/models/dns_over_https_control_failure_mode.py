...
class DnsOverHttpsControlFailureMode(str, Enum):
    """
    Upon DNS-over-HTTPS resolve failure. Required when action is 'enable'.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DnsOverHttpsControlFailureMode from a JSON string"""
