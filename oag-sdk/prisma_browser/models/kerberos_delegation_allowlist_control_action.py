...
class KerberosDelegationAllowlistControlAction(str, Enum):
    """
    Whether to allow or block Kerberos Delegation Allowlist.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of KerberosDelegationAllowlistControlAction from a JSON string"""
