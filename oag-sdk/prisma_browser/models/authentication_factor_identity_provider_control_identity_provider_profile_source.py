...
class AuthenticationFactorIdentityProviderControlIdentityProviderProfileSource(str, Enum):
    """
    Whether to use the configured authentication profile or specify a custom one.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AuthenticationFactorIdentityProviderControlIdentityProviderProfileSource from a JSON string"""
