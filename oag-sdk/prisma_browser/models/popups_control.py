...
class PopupsControl(BaseModel):
    """
    Control the ability to display popups in the browser.
    """ # noqa: E501
    action: PopupsControlAction
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PopupsControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PopupsControl from a dict"""
        if obj is None:
            return None
