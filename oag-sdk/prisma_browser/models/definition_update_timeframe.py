...
class DefinitionUpdateTimeframe(str, Enum):
    ...
    """
    ENUM_1_WEEK = '1 week'
    ENUM_2_WEEKS = '2 weeks'
    ENUM_3_WEEKS = '3 weeks'
    ENUM_1_MONTH = '1 month'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DefinitionUpdateTimeframe from a JSON string"""
