...
class IssuerCertificate(BaseModel):
    """
    IssuerCertificate
    """ # noqa: E501
    dn: CertificateDN = Field(alias="DN")
    serial_number: StrictStr = Field(alias="serialNumber")
    raw: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["DN", "serialNumber", "raw"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IssuerCertificate from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of dn
        if self.dn:
            _dict['DN'] = self.dn.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IssuerCertificate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "DN": CertificateDN.from_dict(obj["DN"]) if obj.get("DN") is not None else None,
