...
class AuthenticationFactorIdentityProviderControl(BaseModel):
    """
    Identity provider authentication factor settings.
    """ # noqa: E501
    method: AuthenticationFactorIdentityProviderControlMethod
    identity_provider: AuthenticationFactorIdentityProviderControlIdentityProvider = Field(alias="identityProvider")
    __properties: ClassVar[List[str]] = ["method", "identityProvider"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthenticationFactorIdentityProviderControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthenticationFactorIdentityProviderControl from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "identityProvider": AuthenticationFactorIdentityProviderControlIdentityProvider.from_dict(obj["identityProvider"]) if obj.get("identityProvider") is not None else None
        })
        return _obj
