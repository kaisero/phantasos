...
class DeviceFirewallDetails(BaseModel):
    """
    Firewall details for the device
    """ # noqa: E501
    products: List[FirewallProduct] = Field(description="List of firewall products detected on the device")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceFirewallDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceFirewallDetails from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "products": [FirewallProduct.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None
        })
