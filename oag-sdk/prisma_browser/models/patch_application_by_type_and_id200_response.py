...
class PatchApplicationByTypeAndID200Response(BaseModel):
    """
    PatchApplicationByTypeAndID200Response
    """ # noqa: E501
    id: StrictStr = Field(description="The ID of the updated resource")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchApplicationByTypeAndID200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchApplicationByTypeAndID200Response from a dict"""
        if obj is None:
            return None
