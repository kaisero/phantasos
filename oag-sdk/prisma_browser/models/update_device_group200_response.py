...
class UpdateDeviceGroup200Response(BaseModel):
    """
    UpdateDeviceGroup200Response
    """ # noqa: E501
    device_group_id: Optional[StrictStr] = Field(default=None, description="The ID of the updated device group", alias="deviceGroupId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateDeviceGroup200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateDeviceGroup200Response from a dict"""
        if obj is None:
            return None
