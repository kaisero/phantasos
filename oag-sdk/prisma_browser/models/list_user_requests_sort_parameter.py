...
class ListUserRequestsSortParameter(str, Enum):
    """
    ...
    allowed enum values
    """
    REQUEST_DOT_CREATED_AT = 'request.created_at'
    REQUEST_DOT_TYPE = 'request.type'
    REQUEST_DOT_STATUS = 'request.status'
    REQUEST_DOT_RESPONSE_TIME = 'request.response_time'
    REQUEST_DOT_URL = 'request.url'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ListUserRequestsSortParameter from a JSON string"""
