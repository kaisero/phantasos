...
class PositionItemRule(BaseModel):
    """
    A rule in the desired position order
    """ # noqa: E501
    type: PositionItemRuleType
    id: Annotated[str, Field(min_length=29, strict=True, max_length=29)] = Field(description="The rule ID")
    section_id: Optional[Annotated[str, Field(min_length=29, strict=True, max_length=29)]] = Field(default=None, description="The section this rule belongs to (null or omitted = standalone)", alias="sectionId")
    __properties: ClassVar[List[str]] = ["type", "id", "sectionId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PositionItemRule from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PositionItemRule from a dict"""
        if obj is None:
            return None
