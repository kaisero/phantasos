...
class AllowedPrintersControl(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AllowedPrintersControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AllowedPrintersControl from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "allowedPrinters": obj.get("allowedPrinters"),
            "allowSaveAsPdf": obj.get("allowSaveAsPdf") if obj.get("allowSaveAsPdf") is not None else True
        })
        return _obj
