...
class AuthenticationFactorPinCodeControl(BaseModel):
    """
    PIN code authentication factor settings.
    """ # noqa: E501
    method: AuthenticationFactorPinCodeControlMethod
    pin_code: AuthenticationFactorPinCodeControlPinCode = Field(alias="pinCode")
    __properties: ClassVar[List[str]] = ["method", "pinCode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthenticationFactorPinCodeControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthenticationFactorPinCodeControl from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pinCode": AuthenticationFactorPinCodeControlPinCode.from_dict(obj["pinCode"]) if obj.get("pinCode") is not None else None
        })
        return _obj
