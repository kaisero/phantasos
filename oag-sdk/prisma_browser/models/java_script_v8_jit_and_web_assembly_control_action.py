...
class JavaScriptV8JitAndWebAssemblyControlAction(str, Enum):
    """
    JavaScript v8 JIT and WebAssembly protection level.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of JavaScriptV8JitAndWebAssemblyControlAction from a JSON string"""
