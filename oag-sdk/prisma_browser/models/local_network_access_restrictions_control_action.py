...
class LocalNetworkAccessRestrictionsControlAction(str, Enum):
    """
    Whether local network access is enabled.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of LocalNetworkAccessRestrictionsControlAction from a JSON string"""
