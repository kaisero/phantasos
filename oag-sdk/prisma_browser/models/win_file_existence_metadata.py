...
class WinFileExistenceMetadata(BaseModel):
    """
    WinFileExistenceMetadata
    """ # noqa: E501
    path: StrictStr = Field(description="Full path to the file on Windows")
    certificate_thumbprint: Optional[StrictStr] = Field(default=None, description="Certificate thumbprint to validate the file signature", alias="certificateThumbprint")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["path", "certificateThumbprint"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WinFileExistenceMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WinFileExistenceMetadata from a dict"""
        if obj is None:
            return None
