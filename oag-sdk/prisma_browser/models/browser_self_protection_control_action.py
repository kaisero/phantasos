...
class BrowserSelfProtectionControlAction(str, Enum):
    """
    Whether Browser Self-Protection is enabled.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BrowserSelfProtectionControlAction from a JSON string"""
