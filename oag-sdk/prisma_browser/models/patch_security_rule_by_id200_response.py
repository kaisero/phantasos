...
class PatchSecurityRuleByID200Response(BaseModel):
    """
    PatchSecurityRuleByID200Response
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the updated rule.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchSecurityRuleByID200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchSecurityRuleByID200Response from a dict"""
        if obj is None:
            return None
