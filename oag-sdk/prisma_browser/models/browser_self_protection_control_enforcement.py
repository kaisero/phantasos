...
class BrowserSelfProtectionControlEnforcement(str, Enum):
    """
    Enforcement for Inactive Protection. Applies when action is 'enable'.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BrowserSelfProtectionControlEnforcement from a JSON string"""
