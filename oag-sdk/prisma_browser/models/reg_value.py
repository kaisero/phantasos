...
class RegValue(BaseModel):
    ...
    type: Optional[RegistryValueType] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "data", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegValue from a dict"""
        if obj is None:
            return None
