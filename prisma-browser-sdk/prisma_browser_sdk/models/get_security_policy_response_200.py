...
T = TypeVar("T", bound="GetSecurityPolicyResponse200")


@_attrs_define
class GetSecurityPolicyResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_security_policy_response_200 = cls(
            page_info=page_info,
            data=data,
            metadata=metadata,
        )

        get_security_policy_response_200.additional_properties = d
        return get_security_policy_response_200
