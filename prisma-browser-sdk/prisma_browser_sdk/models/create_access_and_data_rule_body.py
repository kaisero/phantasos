...
T = TypeVar("T", bound="CreateAccessAndDataRuleBody")


@_attrs_define
class CreateAccessAndDataRuleBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_access_and_data_rule_body = cls(
            name=name,
            mode=mode,
        ...
        create_access_and_data_rule_body.additional_properties = d
        return create_access_and_data_rule_body
