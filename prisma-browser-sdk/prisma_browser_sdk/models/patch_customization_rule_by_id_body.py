...
T = TypeVar("T", bound="PatchCustomizationRuleByIDBody")


@_attrs_define
class PatchCustomizationRuleByIDBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_customization_rule_by_id_body = cls(
            name=name,
        ...
        patch_customization_rule_by_id_body.additional_properties = d
        return patch_customization_rule_by_id_body
