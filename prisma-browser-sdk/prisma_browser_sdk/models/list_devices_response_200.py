...
T = TypeVar("T", bound="ListDevicesResponse200")


@_attrs_define
class ListDevicesResponse200:
    """
    Attributes:
        page_info (PageInfo | Unset):
        data (list[Device] | Unset):
    """

    page_info: PageInfo | Unset = UNSET
    data: list[Device] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = Device.from_dict(data_item_data)

                data.append(data_item)

        list_devices_response_200 = cls(
            page_info=page_info,
            data=data,
        )

        list_devices_response_200.additional_properties = d
        return list_devices_response_200
