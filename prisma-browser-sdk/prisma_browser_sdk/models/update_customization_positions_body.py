...
T = TypeVar("T", bound="UpdateCustomizationPositionsBody")


@_attrs_define
class UpdateCustomizationPositionsBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_customization_positions_body = cls(
            positions=positions,
        )

        return update_customization_positions_body
