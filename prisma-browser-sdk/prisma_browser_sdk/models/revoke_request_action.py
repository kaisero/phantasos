...
T = TypeVar("T", bound="RevokeRequestAction")


@_attrs_define
class RevokeRequestAction:
    """
    Attributes:
        revoker_comment (str | Unset): Admin revoke comment
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        revoke_request_action = cls(
            revoker_comment=revoker_comment,
        )

        revoke_request_action.additional_properties = d
        return revoke_request_action
