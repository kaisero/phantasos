...
T = TypeVar("T", bound="UpdateDeviceGroupResponse200")


@_attrs_define
class UpdateDeviceGroupResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_device_group_response_200 = cls(
            device_group_id=device_group_id,
        )

        update_device_group_response_200.additional_properties = d
        return update_device_group_response_200
