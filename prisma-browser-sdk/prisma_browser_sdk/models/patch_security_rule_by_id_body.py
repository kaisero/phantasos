...
T = TypeVar("T", bound="PatchSecurityRuleByIDBody")


@_attrs_define
class PatchSecurityRuleByIDBody:
    """
    Attributes:
        ...
        controls (SecurityControls | Unset): Controls for security rules.
    """
    ...
    controls: SecurityControls | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        controls: SecurityControls | Unset
        if isinstance(_controls, Unset):
            controls = UNSET
        else:
            controls = SecurityControls.from_dict(_controls)

        patch_security_rule_by_id_body = cls(
            name=name,
        ...
        patch_security_rule_by_id_body.additional_properties = d
        return patch_security_rule_by_id_body
