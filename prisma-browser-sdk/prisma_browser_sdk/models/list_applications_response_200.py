...
T = TypeVar("T", bound="ListApplicationsResponse200")


@_attrs_define
class ListApplicationsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_applications_response_200 = cls(
            data=data,
            metadata=metadata,
            page_info=page_info,
        )

        list_applications_response_200.additional_properties = d
        return list_applications_response_200
