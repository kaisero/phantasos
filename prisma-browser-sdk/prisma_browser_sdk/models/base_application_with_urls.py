...
T = TypeVar("T", bound="BaseApplicationWithUrls")


@_attrs_define
class BaseApplicationWithUrls:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        base_application_with_urls = cls(
            id=id,
            name=name,
            type_=type_,
            metadata=metadata,
        ...
        base_application_with_urls.additional_properties = d
        return base_application_with_urls
