...
T = TypeVar("T", bound="CustomizationRuleDetailedMetadata")


@_attrs_define
class CustomizationRuleDetailedMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        customization_rule_detailed_metadata = cls(
        ...
        customization_rule_detailed_metadata.additional_properties = d
        return customization_rule_detailed_metadata
