...
T = TypeVar("T", bound="UpdateAccessAndDataPositionsBody")


@_attrs_define
class UpdateAccessAndDataPositionsBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_access_and_data_positions_body = cls(
            positions=positions,
        )

        return update_access_and_data_positions_body
