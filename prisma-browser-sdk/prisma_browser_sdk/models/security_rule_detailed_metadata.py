...
T = TypeVar("T", bound="SecurityRuleDetailedMetadata")


@_attrs_define
class SecurityRuleDetailedMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        security_rule_detailed_metadata = cls(
        ...
        security_rule_detailed_metadata.additional_properties = d
        return security_rule_detailed_metadata
