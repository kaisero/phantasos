...
T = TypeVar("T", bound="SignInRuleDetailedMetadata")


@_attrs_define
class SignInRuleDetailedMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sign_in_rule_detailed_metadata = cls(
        ...
        sign_in_rule_detailed_metadata.additional_properties = d
        return sign_in_rule_detailed_metadata
