...
T = TypeVar("T", bound="BasePatchApplicationInput")


@_attrs_define
class BasePatchApplicationInput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        base_patch_application_input = cls(
            type_=type_,
            name=name,
            description=description,
        )

        base_patch_application_input.additional_properties = d
        return base_patch_application_input
