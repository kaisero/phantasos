...
T = TypeVar("T", bound="GetAccessAndDataPolicyResponse200")


@_attrs_define
class GetAccessAndDataPolicyResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_access_and_data_policy_response_200 = cls(
            page_info=page_info,
            data=data,
            metadata=metadata,
        )

        get_access_and_data_policy_response_200.additional_properties = d
        return get_access_and_data_policy_response_200
