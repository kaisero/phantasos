...
T = TypeVar("T", bound="ListUserGroupsResponse200")


@_attrs_define
class ListUserGroupsResponse200:
    """
    Attributes:
        page_info (PageInfo | Unset):
        data (list[UserGroup] | Unset):
    """

    page_info: PageInfo | Unset = UNSET
    data: list[UserGroup] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = UserGroup.from_dict(data_item_data)

                data.append(data_item)

        list_user_groups_response_200 = cls(
            page_info=page_info,
            data=data,
        )

        list_user_groups_response_200.additional_properties = d
        return list_user_groups_response_200
