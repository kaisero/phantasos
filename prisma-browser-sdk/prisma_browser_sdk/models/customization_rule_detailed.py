...
if TYPE_CHECKING:
    from ..models.customization_rule_detailed_metadata import CustomizationRuleDetailedMetadata
    from ..models.get_scope import GetScope
    from ..models.section_ref import SectionRef


T = TypeVar("T", bound="CustomizationRuleDetailed")


@_attrs_define
class CustomizationRuleDetailed:
    """A detailed customization rule object with complete configuration
    ...
    Attributes:
        ...
        scope (GetScope):
        metadata (CustomizationRuleDetailedMetadata):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        metadata = CustomizationRuleDetailedMetadata.from_dict(d.pop("metadata"))
        ...
        customization_rule_detailed = cls(
            id=id,
            name=name,
            priority=priority,
            mode=mode,
        ...
        customization_rule_detailed.additional_properties = d
        return customization_rule_detailed
