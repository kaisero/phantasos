...
T = TypeVar("T", bound="CreateSecurityRuleBody")


@_attrs_define
class CreateSecurityRuleBody:
    """Request body for creating a Security Policy rule.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_security_rule_body.additional_properties = d
        return create_security_rule_body
