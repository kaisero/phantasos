...
from ..models.access_and_data_rule_mode import AccessAndDataRuleMode
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.access_and_data_rule_detailed_metadata import AccessAndDataRuleDetailedMetadata
    from ..models.get_scope import GetScope
    from ..models.section_ref import SectionRef


T = TypeVar("T", bound="AccessAndDataRuleDetailed")


@_attrs_define
class AccessAndDataRuleDetailed:
    ...
    Attributes:
        ...
        mode (AccessAndDataRuleMode): The mode of the rule.
        scope (GetScope):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mode = AccessAndDataRuleMode(d.pop("mode"))

        scope = GetScope.from_dict(d.pop("scope"))

        metadata = AccessAndDataRuleDetailedMetadata.from_dict(d.pop("metadata"))
        ...
        access_and_data_rule_detailed = cls(
            id=id,
            name=name,
            priority=priority,
            mode=mode,
        ...
        access_and_data_rule_detailed.additional_properties = d
        return access_and_data_rule_detailed
