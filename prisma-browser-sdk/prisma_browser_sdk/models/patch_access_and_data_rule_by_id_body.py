...
T = TypeVar("T", bound="PatchAccessAndDataRuleByIDBody")


@_attrs_define
class PatchAccessAndDataRuleByIDBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_access_and_data_rule_by_id_body = cls(
            name=name,
        ...
        patch_access_and_data_rule_by_id_body.additional_properties = d
        return patch_access_and_data_rule_by_id_body
