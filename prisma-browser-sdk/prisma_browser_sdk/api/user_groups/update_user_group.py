...
) -> Any | UpdateUserGroupResponse200 | UpdateUserGroupResponse400 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | UpdateUserGroupResponse200 | UpdateUserGroupResponse400]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | UpdateUserGroupResponse200 | UpdateUserGroupResponse400
    """
