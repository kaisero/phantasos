...
from ...models.update_sign_in_positions_body import UpdateSignInPositionsBody
from ...types import Response


def _get_kwargs(
    *,
    body: UpdateSignInPositionsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/seb-api/v1/policy/sign-in/positions",
    }
...
def sync_detailed(
    *,
    ...
    """Update rule and section positions in the sign-in policy
     ...
     Submits the full ordered list of rules and sections for the sign-in policy. Array index determines
