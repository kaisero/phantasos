...
from ...models.get_application_by_type_and_id_response_400 import GetApplicationByTypeAndIDResponse400
from ...models.get_application_by_type_and_id_type import GetApplicationByTypeAndIDType
...
def _get_kwargs(
    type_: GetApplicationByTypeAndIDType,
    id: str,
    *,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 400:
        response_400 = GetApplicationByTypeAndIDResponse400.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Any | CatalogApplication | CustomApplication | LocalDesktopApplication | NonWebApplication | PrivateApplication | GetApplicationByTypeAndIDResponse400]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | CatalogApplication | CustomApplication | LocalDesktopApplication | NonWebApplication | PrivateApplication | GetApplicationByTypeAndIDResponse400
    """
