...
) -> Any | DeviceRestoreResponse | RestoreDevicesResponse400 | RestoreDevicesResponse404 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | DeviceRestoreResponse | RestoreDevicesResponse400 | RestoreDevicesResponse404]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Any | DeviceRestoreResponse | RestoreDevicesResponse400 | RestoreDevicesResponse404
    """
