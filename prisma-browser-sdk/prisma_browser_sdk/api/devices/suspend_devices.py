...
) -> ApiError | DeviceSuspendResponse | SuspendDevicesResponse400 | SuspendDevicesResponse404 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiError | DeviceSuspendResponse | SuspendDevicesResponse400 | SuspendDevicesResponse404]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiError | DeviceSuspendResponse | SuspendDevicesResponse400 | SuspendDevicesResponse404
    """
