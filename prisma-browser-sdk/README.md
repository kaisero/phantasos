# prisma-browser-sdk
A client library for accessing Prisma Browser Management Console Public API

## Usage
First, create a client:

```python
from prisma_browser_sdk import Client
...
```python
from prisma_browser_sdk import AuthenticatedClient
...
```python
from prisma_browser_sdk.models import MyDataModel
from prisma_browser_sdk.api.my_tag import get_my_data_model
from prisma_browser_sdk.types import Response
...
1. Any endpoint which did not have a tag will be in `prisma_browser_sdk.api.default`
