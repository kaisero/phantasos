...
from prisma_browser.api_response import ApiResponse, T as ApiResponseT
import prisma_browser.models
from prisma_browser import rest
from prisma_browser.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(prisma_browser.models, klass)
