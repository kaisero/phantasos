...
class Metadata(BaseModel):
    ...
    Metadata
    """ # noqa: E501
    created_time: datetime = Field(description="Creation time", alias="createdTime")
    last_updated_time: datetime = Field(description="Last update time", alias="lastUpdatedTime")
    created_by: Optional[StrictStr] = Field(default=None, description="Created by user", alias="createdBy")
    last_updated_by: Optional[StrictStr] = Field(default=None, description="Updated by user", alias="lastUpdatedBy")
    configuration_version: Optional[MetadataConfigurationVersion] = Field(default=None, alias="configurationVersion")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["createdTime", "lastUpdatedTime", "createdBy", "lastUpdatedBy", "configurationVersion"]
