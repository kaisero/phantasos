...
class AllowBlockControl(BaseModel):
    """
    A simple control with an allow or block action. Re-usable by any data control that only needs a binary allow/block decision.
    """ # noqa: E501
    action: AllowBlockControlAction
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AllowBlockControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AllowBlockControl from a dict"""
        if obj is None:
            return None
