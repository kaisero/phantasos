...
class LocalDesktopApplicationAllOfExecutables(BaseModel):
    """
    Local Desktop Application Executables
    """ # noqa: E501
    data: List[LocalDesktopApplicationAllOfExecutablesData] = Field(description="List of executables for the local desktop application")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LocalDesktopApplicationAllOfExecutables from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LocalDesktopApplicationAllOfExecutables from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [LocalDesktopApplicationAllOfExecutablesData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
