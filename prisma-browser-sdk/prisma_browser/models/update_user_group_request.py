...
class UpdateUserGroupRequest(BaseModel):
    ...
    """ # noqa: E501
    users: List[UpdateUserGroupRequestUsersInner] = Field(description="List of user updates")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [UpdateUserGroupRequestUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
