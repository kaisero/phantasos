...
class MacOSFileExistenceMetadata(BaseModel):
    """
    MacOSFileExistenceMetadata
    """ # noqa: E501
    path: StrictStr = Field(description="Full path to the file on macOS")
    team_identifier: Optional[StrictStr] = Field(default=None, description="Apple Team Identifier to validate the file signature", alias="teamIdentifier")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["path", "teamIdentifier"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MacOSFileExistenceMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MacOSFileExistenceMetadata from a dict"""
        if obj is None:
            return None
