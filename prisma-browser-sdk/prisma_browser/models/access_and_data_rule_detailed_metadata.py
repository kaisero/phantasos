...
class AccessAndDataRuleDetailedMetadata(BaseModel):
    """
    ...
    created_by: StrictStr = Field(description="Email or identifier of the admin who created the rule", alias="createdBy")
    created_time: datetime = Field(description="Timestamp when the rule was created", alias="createdTime")
    last_updated_by: StrictStr = Field(description="Email or identifier of the admin who last updated the rule", alias="lastUpdatedBy")
    last_updated_time: datetime = Field(description="Timestamp when the rule was last updated", alias="lastUpdatedTime")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["configurationVersion", "createdBy", "createdTime", "lastUpdatedBy", "lastUpdatedTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessAndDataRuleDetailedMetadata from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.configuration_version is None and "configuration_version" in self.model_fields_set:
            _dict['configurationVersion'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessAndDataRuleDetailedMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "configurationVersion": MetadataConfigurationVersion.from_dict(obj["configurationVersion"]) if obj.get("configurationVersion") is not None else None,
