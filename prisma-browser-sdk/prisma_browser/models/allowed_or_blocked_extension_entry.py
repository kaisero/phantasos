...
class AllowedOrBlockedExtensionEntry(BaseModel):
    """
    AllowedOrBlockedExtensionEntry
    """ # noqa: E501
    id: Annotated[str, Field(min_length=32, strict=True, max_length=32)] = Field(description="Chrome extension ID.")
    __properties: ClassVar[List[str]] = ["id"]

    @field_validator('id')
    def id_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^[a-p]{32}$", value):
            raise ValueError(r"must validate the regular expression /^[a-p]{32}$/")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AllowedOrBlockedExtensionEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AllowedOrBlockedExtensionEntry from a dict"""
        if obj is None:
            return None
