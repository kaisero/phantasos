...
class GetScopeLocations(BaseModel):
    """
    The locations the rule applies to.
    """ # noqa: E501
    is_any: StrictBool = Field(description="Flag indicating if any locations are included in the scope.", alias="isAny")
    locations: List[Locations] = Field(description="Geographical locations to which the rule applies.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetScopeLocations from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetScopeLocations from a dict"""
        if obj is None:
            return None
