...
class RestrictExtensionHostPermissionsControl(BaseModel):
    """
    Prevent extensions from running scripts and accessing content in websites.
    """ # noqa: E501
    action: RestrictExtensionHostPermissionsControlAction
    included_domains: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=2048)]], Field(max_length=1000)]] = Field(default=None, description="Domains where extension host permissions are restricted.", alias="includedDomains")
    __properties: ClassVar[List[str]] = ["action", "includedDomains"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RestrictExtensionHostPermissionsControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RestrictExtensionHostPermissionsControl from a dict"""
        if obj is None:
            return None
