...
class DeviceResumeResponse(BaseModel):
    ...
    """ # noqa: E501
    resumed_device_ids: Optional[List[StrictStr]] = Field(default=None, description="List of device IDs that were resumed", alias="resumedDeviceIds")
    message: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["resumedDeviceIds", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resumedDeviceIds": obj.get("resumedDeviceIds"),
