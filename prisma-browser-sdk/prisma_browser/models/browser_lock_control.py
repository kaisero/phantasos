...
class BrowserLockControl(BaseModel):
    """
    Require the user to unlock their browser.
    """ # noqa: E501
    action: BrowserLockControlAction
    idle_timeout_minutes: Optional[BrowserLockControlIdleTimeoutMinutes] = Field(default=None, alias="idleTimeoutMinutes")
    __properties: ClassVar[List[str]] = ["action", "idleTimeoutMinutes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserLockControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserLockControl from a dict"""
        if obj is None:
            return None
