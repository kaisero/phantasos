...
class DeviceDiskEncryptionDetails(BaseModel):
    """
    Disk encryption details for the device
    """ # noqa: E501
    products: List[DiskEncryptionProduct] = Field(description="List of disk encryption products detected on the device")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceDiskEncryptionDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceDiskEncryptionDetails from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "products": [DiskEncryptionProduct.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None
        })
