...
class PublishDraftConfiguration501Response(BaseModel):
    """
    PublishDraftConfiguration501Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="info message")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublishDraftConfiguration501Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublishDraftConfiguration501Response from a dict"""
        if obj is None:
            return None
