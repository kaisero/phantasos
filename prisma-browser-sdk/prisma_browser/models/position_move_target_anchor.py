...
class PositionMoveTargetAnchor(BaseModel):
    """
    ...
    """ # noqa: E501
    type: PositionMoveTargetAnchorType
    id: Annotated[str, Field(min_length=29, strict=True, max_length=29)] = Field(description="The entity ID of the anchor item. Must match the actual entity type specified in 'type'.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PositionMoveTargetAnchor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PositionMoveTargetAnchor from a dict"""
        if obj is None:
            return None
