...
class CrowdstrikeZTAPosture(BaseModel):
    """
    CrowdstrikeZTAPosture
    """ # noqa: E501
    score: StrictInt
    sensor_score: StrictInt = Field(alias="sensorScore")
    os_score: StrictInt = Field(alias="osScore")
    cid: StrictStr = Field(alias="CID")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["score", "sensorScore", "osScore", "CID"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CrowdstrikeZTAPosture from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CrowdstrikeZTAPosture from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "score": obj.get("score"),
            "sensorScore": obj.get("sensorScore"),
            "osScore": obj.get("osScore"),
            "CID": obj.get("CID")
        })
