...
class MacOSRunningProcessMetadata(BaseModel):
    """
    MacOSRunningProcessMetadata
    """ # noqa: E501
    name: StrictStr = Field(description="Process name or path on macOS")
    team_identifier: Optional[StrictStr] = Field(default=None, description="Apple Team Identifier to validate the process signature", alias="teamIdentifier")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "teamIdentifier"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MacOSRunningProcessMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MacOSRunningProcessMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "teamIdentifier": obj.get("teamIdentifier")
        })
