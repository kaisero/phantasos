...
class LocalDesktopApplication(BaseModel):
    """
    ...
    type: LocalDesktopApplicationAllOfType
    category: Optional[StrictStr] = None
    metadata: Metadata
    executables: LocalDesktopApplicationAllOfExecutables
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "description", "type", "category", "metadata", "executables"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LocalDesktopApplication from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LocalDesktopApplication from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "executables": LocalDesktopApplicationAllOfExecutables.from_dict(obj["executables"]) if obj.get("executables") is not None else None
        })
