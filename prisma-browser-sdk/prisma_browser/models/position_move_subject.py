...
class PositionMoveSubject(BaseModel):
    """
    The entity to be moved (rule or section).
    """ # noqa: E501
    type: PositionMoveSubjectType
    id: Annotated[str, Field(min_length=29, strict=True, max_length=29)] = Field(description="The entity ID of the subject. In draft mode this is the EntityID; otherwise it is the row ID. Must match the actual entity type specified in 'type'.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PositionMoveSubject from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PositionMoveSubject from a dict"""
        if obj is None:
            return None
