...
class NonWebApplication(BaseModel):
    """
    Non-Web Application
    """ # noqa: E501
    ...
    type: NonWebApplicationAllOfType
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "type", "category", "metadata", "urls", "protocol", "port", "routeToPrisma"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NonWebApplication from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NonWebApplication from a dict"""
        if obj is None:
            return None
