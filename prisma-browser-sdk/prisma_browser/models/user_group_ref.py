...
class UserGroupRef(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="User group identifier")
    name: StrictStr = Field(description="User group display name")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserGroupRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserGroupRef from a dict"""
        if obj is None:
            return None
