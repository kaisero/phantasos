...
class WindowsVersion(BaseModel):
    ...
    enabled: StrictBool
    major: StrictStr
    min_build_number: Optional[StrictStr] = Field(default=None, alias="minBuildNumber")
    editions: Optional[List[WindowsEdition]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["enabled", "major", "minBuildNumber", "editions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "major": obj.get("major"),
            "minBuildNumber": obj.get("minBuildNumber"),
