...
class UpdateUserGroupRequestUsersInner(BaseModel):
    """
    UpdateUserGroupRequestUsersInner
    """ # noqa: E501
    user_id: StrictStr = Field(description="User ID", alias="userId")
    action: UpdateUserGroupRequestUsersInnerAction
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["userId", "action"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateUserGroupRequestUsersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateUserGroupRequestUsersInner from a dict"""
        if obj is None:
            return None
