...
class AttributeObjectOsPassword(BaseModel):
    """
    ...
    enabled: StrictBool
    complexity: Optional[OsPasswordComplexity] = None
    max_age: Optional[StrictInt] = Field(default=None, description="Maximum password age in days", alias="maxAge")
    min_length: Optional[StrictInt] = Field(default=None, description="Minimum password length in characters", alias="minLength")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["negate", "enabled", "complexity", "maxAge", "minLength"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttributeObjectOsPassword from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttributeObjectOsPassword from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "complexity": OsPasswordComplexity.from_dict(obj["complexity"]) if obj.get("complexity") is not None else None,
