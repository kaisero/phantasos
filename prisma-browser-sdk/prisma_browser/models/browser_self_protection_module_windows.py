...
class BrowserSelfProtectionModuleWindows(BaseModel):
    """
    Windows driver info
    """ # noqa: E501
    status: Optional[BrowserSelfProtectionWindowsDriverStatus] = BrowserSelfProtectionWindowsDriverStatus.UNKNOWN
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserSelfProtectionModuleWindows from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserSelfProtectionModuleWindows from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "status": obj.get("status") if obj.get("status") is not None else BrowserSelfProtectionWindowsDriverStatus.UNKNOWN
        })
