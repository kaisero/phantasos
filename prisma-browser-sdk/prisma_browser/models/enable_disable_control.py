...
class EnableDisableControl(BaseModel):
    """
    A simple control with an enable or disable action. Re-usable by any control that only needs a binary enable/disable decision.
    """ # noqa: E501
    action: EnableDisableControlAction
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnableDisableControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnableDisableControl from a dict"""
        if obj is None:
            return None
