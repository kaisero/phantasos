...
class LinuxVersionAttribute(BaseModel):
    """
    LinuxVersionAttribute
    """ # noqa: E501
    any: Optional[StrictBool] = Field(default=False, description="Accept any Linux version")
    versions: Optional[List[LinuxVersion]] = Field(default=None, description="List of specific Linux distributions and versions to check for")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["any", "versions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LinuxVersionAttribute from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LinuxVersionAttribute from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "versions": [LinuxVersion.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
