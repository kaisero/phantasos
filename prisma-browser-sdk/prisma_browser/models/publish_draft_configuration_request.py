...
class PublishDraftConfigurationRequest(BaseModel):
    """
    PublishDraftConfigurationRequest
    """ # noqa: E501
    description: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Provide description to describe this version")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublishDraftConfigurationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublishDraftConfigurationRequest from a dict"""
        if obj is None:
            return None
