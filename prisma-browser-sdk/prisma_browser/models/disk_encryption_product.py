...
class DiskEncryptionProduct(BaseModel):
    """
    Disk encryption product information
    """ # noqa: E501
    vendor_name: DiskEncryptionVendorName = Field(alias="vendorName")
    product_name: StrictStr = Field(description="Product name of the disk encryption product", alias="productName")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["vendorName", "productName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DiskEncryptionProduct from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DiskEncryptionProduct from a dict"""
        if obj is None:
            return None
