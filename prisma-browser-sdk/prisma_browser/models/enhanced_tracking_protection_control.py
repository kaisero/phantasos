...
class EnhancedTrackingProtectionControl(BaseModel):
    """
    Manage tracking protection and cross-site tracking.
    """ # noqa: E501
    action: EnhancedTrackingProtectionControlAction
    exclude_domains: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=2048)]], Field(max_length=1000)]] = Field(default=None, description="List of excluded domains.", alias="excludeDomains")
    __properties: ClassVar[List[str]] = ["action", "excludeDomains"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnhancedTrackingProtectionControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnhancedTrackingProtectionControl from a dict"""
        if obj is None:
            return None
