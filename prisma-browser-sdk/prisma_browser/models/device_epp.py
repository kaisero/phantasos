...
class DeviceEPP(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["products", "enabled"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceEPP from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceEPP from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "products": [EPP.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None,
