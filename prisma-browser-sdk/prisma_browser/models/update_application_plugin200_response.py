...
class UpdateApplicationPlugin200Response(BaseModel):
    """
    UpdateApplicationPlugin200Response
    """ # noqa: E501
    plugin_id: Optional[StrictStr] = Field(default=None, description="The ID of the updated plugin", alias="pluginId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateApplicationPlugin200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateApplicationPlugin200Response from a dict"""
        if obj is None:
            return None
