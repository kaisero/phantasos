...
class DeviceManagementSystem(BaseModel):
    """
    DeviceManagementSystem
    """ # noqa: E501
    system: Optional[DeviceManagementSystemSystem] = None
    details: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["system", "details"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceManagementSystem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceManagementSystem from a dict"""
        if obj is None:
            return None
