...
class InternetExplorerCompatibilityModeControl(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InternetExplorerCompatibilityModeControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InternetExplorerCompatibilityModeControl from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "sites": [InternetExplorerCompatibilitySite.from_dict(_item) for _item in obj["sites"]] if obj.get("sites") is not None else None
        })
        return _obj
