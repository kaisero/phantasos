...
class ListApplicationPlugins200Response(BaseModel):
    """
    ListApplicationPlugins200Response
    """ # noqa: E501
    data: Optional[List[PluginResponse]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListApplicationPlugins200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListApplicationPlugins200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [PluginResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
