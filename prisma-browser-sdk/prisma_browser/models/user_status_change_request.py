...
class UserStatusChangeRequest(BaseModel):
    ...
    """ # noqa: E501
    user_ids: Annotated[List[StrictStr], Field(min_length=1)] = Field(description="List of user IDs", alias="userIds")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserStatusChangeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserStatusChangeRequest from a dict"""
        if obj is None:
            return None
