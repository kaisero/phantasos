...
class DeviceArchiveResponse(BaseModel):
    """
    DeviceArchiveResponse
    """ # noqa: E501
    archived_device_ids: Optional[List[StrictStr]] = Field(default=None, description="List of device IDs that were archived", alias="archivedDeviceIds")
    message: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["archivedDeviceIds", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceArchiveResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceArchiveResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "archivedDeviceIds": obj.get("archivedDeviceIds"),
