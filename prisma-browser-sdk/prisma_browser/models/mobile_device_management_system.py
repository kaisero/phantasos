...
class MobileDeviceManagementSystem(BaseModel):
    """
    MobileDeviceManagementSystem
    """ # noqa: E501
    name: MobileDeviceManagementSystemName
    configuration_value: Optional[StrictStr] = Field(default=None, alias="configurationValue")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "configurationValue"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MobileDeviceManagementSystem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MobileDeviceManagementSystem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "configurationValue": obj.get("configurationValue")
        })
