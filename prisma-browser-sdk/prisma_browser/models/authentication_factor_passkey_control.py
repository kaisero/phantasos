...
class AuthenticationFactorPasskeyControl(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["method", "passkey"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthenticationFactorPasskeyControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthenticationFactorPasskeyControl from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "passkey": AuthenticationFactorPasskeyControlPasskey.from_dict(obj["passkey"]) if obj.get("passkey") is not None else None
        })
        return _obj
