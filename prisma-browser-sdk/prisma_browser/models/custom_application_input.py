...
class CustomApplicationInput(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "type", "urls", "category"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomApplicationInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomApplicationInput from a dict"""
        if obj is None:
            return None
