...
class AttributeObjectRegistry(BaseModel):
    """
    Check if the device has all of the specified registry key configurations (Windows only)
    """ # noqa: E501
    negate: Optional[StrictBool] = False
    enabled: StrictBool
    reg_keys: Optional[List[RegKey]] = Field(default=None, description="Registry key configurations to validate", alias="regKeys")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["negate", "enabled", "regKeys"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttributeObjectRegistry from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in reg_keys (list)
        _items = []
        if self.reg_keys:
            for _item in self.reg_keys:
                if _item:
                    _items.append(_item.to_dict())
            _dict['regKeys'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttributeObjectRegistry from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "regKeys": [RegKey.from_dict(_item) for _item in obj["regKeys"]] if obj.get("regKeys") is not None else None
        })
