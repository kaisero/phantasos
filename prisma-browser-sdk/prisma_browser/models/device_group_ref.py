...
class DeviceGroupRef(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Device group identifier")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceGroupRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceGroupRef from a dict"""
        if obj is None:
            return None
