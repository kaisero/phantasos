...
class PagesWithInsecureContentControl(BaseModel):
    """
    Set whether pages with insecure content are available.
    """ # noqa: E501
    action: PagesWithInsecureContentControlAction
    excluded_domains: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=2048)]], Field(max_length=1000)]] = Field(default=None, description="Domains excluded from the chosen action.", alias="excludedDomains")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PagesWithInsecureContentControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PagesWithInsecureContentControl from a dict"""
        if obj is None:
            return None
