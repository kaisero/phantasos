...
class AddRemoveUrls(BaseModel):
    """
    Add or remove URLs from an application. The total URL count after modification cannot exceed 100.
    """ # noqa: E501
    add: Optional[Annotated[List[UrlInput], Field(max_length=100)]] = None
    remove: Optional[List[UrlInput]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddRemoveUrls from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddRemoveUrls from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "add": [UrlInput.from_dict(_item) for _item in obj["add"]] if obj.get("add") is not None else None,
            "remove": [UrlInput.from_dict(_item) for _item in obj["remove"]] if obj.get("remove") is not None else None
        })
