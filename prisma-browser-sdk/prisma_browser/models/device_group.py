...
class DeviceGroup(BaseModel):
    ...
    name: StrictStr = Field(description="Device group name")
    platform: DeviceGroupPlatform
    created_by: Optional[StrictStr] = Field(default=None, description="Created by user", alias="createdBy")
    updated_by: Optional[StrictStr] = Field(default=None, description="Updated by user", alias="updatedBy")
    created_at: datetime = Field(description="Created at timestamp", alias="createdAt")
    updated_at: datetime = Field(description="Updated at timestamp", alias="updatedAt")
    attributes: Optional[AttributeObject] = None
    devices: Optional[List[StrictStr]] = Field(default=None, description="Device IDs in this group")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "platform", "createdBy", "updatedBy", "createdAt", "updatedAt", "attributes", "devices"]
