...
class AttributeObjectDeviceType(BaseModel):
    """
    Check if the device matches specific device types (e.g., desktop, laptop, virtual machine)
    """ # noqa: E501
    negate: Optional[StrictBool] = False
    enabled: StrictBool
    types: Optional[List[DeviceType]] = Field(default=None, description="List of device types to check for")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["negate", "enabled", "types"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttributeObjectDeviceType from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttributeObjectDeviceType from a dict"""
        if obj is None:
            return None
