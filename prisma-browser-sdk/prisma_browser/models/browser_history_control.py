...
class BrowserHistoryControl(BaseModel):
    """
    Control the ability to delete history from the browser.
    """ # noqa: E501
    action: BrowserHistoryControlAction
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserHistoryControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserHistoryControl from a dict"""
        if obj is None:
            return None
