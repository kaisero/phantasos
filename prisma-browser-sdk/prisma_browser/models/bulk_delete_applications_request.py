...
class BulkDeleteApplicationsRequest(BaseModel):
    ...
    """ # noqa: E501
    app_ids: Annotated[List[Annotated[str, Field(strict=True)]], Field(min_length=1, max_length=2000)] = Field(description="Array of application IDs to be deleted", alias="appIds")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BulkDeleteApplicationsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BulkDeleteApplicationsRequest from a dict"""
        if obj is None:
            return None
