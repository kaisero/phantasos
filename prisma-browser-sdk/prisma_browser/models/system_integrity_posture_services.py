...
class SystemIntegrityPostureServices(BaseModel):
    """
    SystemIntegrityPostureServices
    """ # noqa: E501
    drivers_signing_enforcement: Optional[StrictBool] = Field(default=None, alias="driversSigningEnforcement")
    kernel_debugger: Optional[StrictBool] = Field(default=None, alias="kernelDebugger")
    secure_boot: Optional[StrictBool] = Field(default=None, alias="secureBoot")
    sip: Optional[StrictBool] = Field(default=None, alias="SIP")
    gatekeeper: Optional[StrictBool] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["driversSigningEnforcement", "kernelDebugger", "secureBoot", "SIP", "gatekeeper"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SystemIntegrityPostureServices from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SystemIntegrityPostureServices from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "driversSigningEnforcement": obj.get("driversSigningEnforcement"),
            "kernelDebugger": obj.get("kernelDebugger"),
            "secureBoot": obj.get("secureBoot"),
            "SIP": obj.get("SIP"),
            "gatekeeper": obj.get("gatekeeper")
        })
