...
class PageInfo(BaseModel):
    ...
    PageInfo
    """ # noqa: E501
    has_next_page: StrictBool = Field(description="When paginating forwards, are there more items?", alias="hasNextPage")
    cursor: Optional[StrictStr] = Field(default=None, description="When paginating forwards, the cursor to continue.")
    total_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Total number of items across all pages. Currently populated only by policy GET endpoints.", alias="totalCount")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["hasNextPage", "cursor", "totalCount"]
