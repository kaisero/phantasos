...
class AttributeObjectSerialNumber(BaseModel):
    """
    Check if the device's serial number is included in the provided list
    """ # noqa: E501
    negate: Optional[StrictBool] = False
    enabled: StrictBool
    serials: Optional[List[StrictStr]] = Field(default=None, description="List of device serial numbers to check for")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["negate", "enabled", "serials"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttributeObjectSerialNumber from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttributeObjectSerialNumber from a dict"""
        if obj is None:
            return None
