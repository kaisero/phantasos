...
class SelectedDeviceVendor(BaseModel):
    """
    Device manufacturer with optional specific models
    """ # noqa: E501
    manufacturer: DeviceManufacturer
    models: Optional[List[StrictStr]] = Field(default=None, description="Optional list of specific device models from this manufacturer")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["manufacturer", "models"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SelectedDeviceVendor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SelectedDeviceVendor from a dict"""
        if obj is None:
            return None
