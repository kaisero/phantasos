...
class AttributeObjectMobileOsVersion(BaseModel):
    """
    Check if the mobile device is running a specific iOS or Android version
    """ # noqa: E501
    enabled: StrictBool
    ios: Optional[MobileOsVersion] = None
    android: Optional[MobileOsVersion] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["enabled", "ios", "android"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttributeObjectMobileOsVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttributeObjectMobileOsVersion from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "ios": MobileOsVersion.from_dict(obj["ios"]) if obj.get("ios") is not None else None,
            "android": MobileOsVersion.from_dict(obj["android"]) if obj.get("android") is not None else None
        })
