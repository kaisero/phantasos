...
class LocalDesktopApplicationAllOfExecutablesData(BaseModel):
    """
    Local Desktop Application Executable
    """ # noqa: E501
    original_file_name: StrictStr = Field(description="The original executable file name", alias="originalFileName")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["originalFileName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LocalDesktopApplicationAllOfExecutablesData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LocalDesktopApplicationAllOfExecutablesData from a dict"""
        if obj is None:
            return None
