...
class PluginElement(BaseModel):
    ...
    PluginElement
    """ # noqa: E501
    element_type: PluginElementElementType = Field(alias="elementType")
    url_pattern: Optional[StrictStr] = Field(default=None, alias="urlPattern")
    selectors: List[StrictStr]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["elementType", "urlPattern", "selectors"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PluginElement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PluginElement from a dict"""
        if obj is None:
            return None
