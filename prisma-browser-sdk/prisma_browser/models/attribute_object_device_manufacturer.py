...
class AttributeObjectDeviceManufacturer(BaseModel):
    """
    Check if the device is from specific manufacturers (e.g., Dell, HP, Lenovo)
    """ # noqa: E501
    negate: Optional[StrictBool] = False
    enabled: StrictBool
    selected_vendors: Optional[List[SelectedDeviceVendor]] = Field(default=None, description="List of device manufacturers with optional specific models to check for", alias="selectedVendors")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["negate", "enabled", "selectedVendors"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttributeObjectDeviceManufacturer from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in selected_vendors (list)
        _items = []
        if self.selected_vendors:
            for _item in self.selected_vendors:
                if _item:
                    _items.append(_item.to_dict())
            _dict['selectedVendors'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttributeObjectDeviceManufacturer from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "selectedVendors": [SelectedDeviceVendor.from_dict(_item) for _item in obj["selectedVendors"]] if obj.get("selectedVendors") is not None else None
        })
