...
class SectionPostRequest(BaseModel):
    ...
    SectionPostRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="The name of the section.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SectionPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SectionPostRequest from a dict"""
        if obj is None:
            return None
