...
class AttributeObjectDeviceManagement(BaseModel):
    """
    Check if the device is managed by specific device management systems (e.g., Microsoft Intune, Jamf, Active Directory)
    """ # noqa: E501
    negate: Optional[StrictBool] = False
    enabled: StrictBool
    systems: Optional[List[DeviceManagementSystemInput]] = Field(default=None, description="Device management system configurations")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["negate", "enabled", "systems"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttributeObjectDeviceManagement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttributeObjectDeviceManagement from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "systems": [DeviceManagementSystemInput.from_dict(_item) for _item in obj["systems"]] if obj.get("systems") is not None else None
        })
