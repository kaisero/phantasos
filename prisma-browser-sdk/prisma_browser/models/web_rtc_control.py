...
class WebRtcControl(BaseModel):
    """
    Control the use of WebRTC mechanism, which might be exploited. Disabling it might impact the usability of websites working with WebRTC functionalities, like call/video streaming.
    """ # noqa: E501
    action: WebRtcControlAction
    excluded_domains: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=2048)]], Field(max_length=1000)]] = Field(default=None, description="Domains excluded from the block action.", alias="excludedDomains")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebRtcControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebRtcControl from a dict"""
        if obj is None:
            return None
