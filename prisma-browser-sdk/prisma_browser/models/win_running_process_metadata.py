...
class WinRunningProcessMetadata(BaseModel):
    """
    WinRunningProcessMetadata
    """ # noqa: E501
    name: StrictStr = Field(description="Process name or path on Windows")
    certificate_thumbprint: Optional[StrictStr] = Field(default=None, description="Certificate thumbprint to validate the process signature", alias="certificateThumbprint")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "certificateThumbprint"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WinRunningProcessMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WinRunningProcessMetadata from a dict"""
        if obj is None:
            return None
