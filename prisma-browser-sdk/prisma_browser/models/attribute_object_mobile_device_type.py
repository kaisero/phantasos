...
class AttributeObjectMobileDeviceType(BaseModel):
    """
    Check if the mobile device matches specific types (e.g., phone, tablet)
    """ # noqa: E501
    enabled: StrictBool
    types: Optional[List[MobileDeviceType]] = Field(default=None, description="List of mobile device types to check for")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AttributeObjectMobileDeviceType from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AttributeObjectMobileDeviceType from a dict"""
        if obj is None:
            return None
