...
class PatchPositionsRequest(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchPositionsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchPositionsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "moves": [PositionMove.from_dict(_item) for _item in obj["moves"]] if obj.get("moves") is not None else None
        })
        return _obj
