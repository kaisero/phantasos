...
class RegKey(BaseModel):
    ...
    """ # noqa: E501
    path: StrictStr
    values: Optional[List[RegValue]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["path", "values"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegKey from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegKey from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "path": obj.get("path"),
            "values": [RegValue.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
