...
class PatchAppGroupInput(BaseModel):
    """
    PatchAppGroupInput
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the application group")
    description: Optional[StrictStr] = Field(default=None, description="Description of the application group")
    applications: Optional[PatchAppGroupInputApplications] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "description", "applications"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchAppGroupInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchAppGroupInput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "applications": PatchAppGroupInputApplications.from_dict(obj["applications"]) if obj.get("applications") is not None else None
        })
