...
class GetScopeDeviceGroups(BaseModel):
    """
    The device groups the rule applies to.
    """ # noqa: E501
    is_any: StrictBool = Field(description="Flag indicating if any device groups are included in the scope.", alias="isAny")
    device_groups: List[DeviceGroupRef] = Field(description="Device groups the rule applies to.", alias="deviceGroups")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetScopeDeviceGroups from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.device_groups:
            for _item in self.device_groups:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetScopeDeviceGroups from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "isAny": obj.get("isAny"),
            "deviceGroups": [DeviceGroupRef.from_dict(_item) for _item in obj["deviceGroups"]] if obj.get("deviceGroups") is not None else None
        })
