...
class DeleteApplicationPlugin200Response(BaseModel):
    """
    DeleteApplicationPlugin200Response
    """ # noqa: E501
    plugin_id: Optional[StrictStr] = Field(default=None, description="The ID of the deleted plugin", alias="pluginId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteApplicationPlugin200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteApplicationPlugin200Response from a dict"""
        if obj is None:
            return None
