...
class BrowserSelfProtectionModule(BaseModel):
    """
    Browser self-protection module
    """ # noqa: E501
    windows: Optional[BrowserSelfProtectionModuleWindows] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserSelfProtectionModule from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserSelfProtectionModule from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "windows": BrowserSelfProtectionModuleWindows.from_dict(obj["windows"]) if obj.get("windows") is not None else None
        })
